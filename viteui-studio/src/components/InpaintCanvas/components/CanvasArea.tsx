...
const CanvasArea = ({
    ...
    // When viewing a timeline item (candidate/commit/reject), always hide mask and border.
    // When on canvas, only show when in canvas mode (entered via sidebar canvas or timeline item click).
    const effectiveShowMask = !isViewingTimelinePreview && maskCanvasFocused && showMask;
    const effectiveShowBorder = !isViewingTimelinePreview && maskCanvasFocused && showBorder;
    const effectiveMaskBorderMode = !isViewingTimelinePreview && maskCanvasFocused && maskBorderMode;
    ...
    const isPartialCandidate = currentGeneration?.status === 'candidate' && currentGeneration?.partial_candidates_info && currentGeneration?.partial_candidates_info.length > 0;
            ...
            <div className="flex-1 overflow-hidden min-h-0" style={{ minHeight: "400px" }}>
                <div className="relative w-full h-full flex items-center justify-center p-8">
                    <LivePreview
                        ...
                        bounds={bounds}
                        maskBorderMode={effectiveMaskBorderMode}
        ...
        return (
            <div className="flex-1 overflow-hidden min-h-0" style={{ minHeight: "400px" }}>
                <div
                    ...
                    tabIndex={0}
                    className={cn(
                        "w-full h-full flex items-center justify-center p-8 overflow-hidden relative transition-colors duration-200 outline-none",
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            transition: isProgrammaticAction
                    ...
                    `,
                        ...
                        <canvas
                            ...
                            style={{
                                ...
                                opacity: effectiveShowMask && !previewImage && !isInpaintGenerating ? 0.8 : 0,
                            }}
                        />
