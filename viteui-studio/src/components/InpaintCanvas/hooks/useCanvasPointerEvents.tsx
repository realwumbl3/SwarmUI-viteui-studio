...
interface CanvasPointerEventsArgs {
    ...
    drawingMode?: string;
    isActive?: boolean;
    setIsProgrammaticAction?: (value: boolean) => void;
}
...
export function useCanvasPointerEvents({
    ...
    const handlePointerDown = useCallback(
        (e: PointerEvent) => {
            ...
            e.preventDefault();
            e.stopPropagation();
            if (setIsProgrammaticAction) setIsProgrammaticAction(false);
        ...
        [canvasState, panTargetRef, setIsProgrammaticAction]
    );
    ...
    const handleMouseDown = useCallback(
        ...
        [canvasState, drawing, inputImage, generationMode, drawingMode, panTargetRef, setIsProgrammaticAction]
    );
