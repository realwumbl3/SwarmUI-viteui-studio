...
const TimelineItem = ({
    ...
    const workspaceActionsAvailable = Boolean(item.workspace && item.genid || item.status === 'candidate');
    ...
    return (
        ...
        >
                        ...
                        {workspaceActionsAvailable &&
                            <>
                                ...
                                <button
                                    ...
                                    className="rounded bg-studio-panel/80 text-studio-textSecondary p-1 hover:bg-studio-surface transition-colors"
                                    title={editorAppName ? `Open in ${editorAppName}` : "Open in MS Paint"}
                                    type="button"
                                >
                                    <Paintbrush size={12} />
                                </button>
            ...
            {(showCommitReject && isActive && (onCommit || onReject)) && (
            ...
            {onUndiscard && (
                <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-studio-panel/90 to-transparent">
                    <button
                        ...
                        className="w-full px-2 py-1 bg-studio-accent text-white text-xs rounded hover:bg-studio-accent/80 transition-colors"
                        type="button"
                    >
                        {undiscardLabel}
                    </button>
