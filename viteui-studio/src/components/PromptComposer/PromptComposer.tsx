...
import { TagSourceProvider, useTagSource } from "./contexts/TagSourceContext";
import { TAG_SOURCES } from "./tagSuggestions/tagHelper";
import {
    Type,
    Edit,
    Wrench,
...
function PromptComposer(props: PromptComposerProps) {
    return (
        <TagSourceProvider workspaceId={props.workspaceId}>
...
function PromptComposerInner({
    ...
    const { tagSource, setTagSource } = useTagSource();
                ...
                <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="flex items-center gap-2">
                        {mode === "composer" && !collapsed && (
                            <div className="flex items-center gap-2 border-r border-studio-border pr-2 ml-2">
                                <OptionPicker
                                    title="Tag Source"
                                    options={Object.keys(TAG_SOURCES).map(s => ({ value: s, label: s }))}
                                    value={tagSource}
